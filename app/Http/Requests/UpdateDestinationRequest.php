...
class UpdateDestinationRequest extends FormRequest
{
    ...
    {
        return array_merge($this->baseRules(), $this->providerRules());
    }
    ...
    private function providerRules(): array
    {
        return match ($this->input('provider')) {
            ...
            BackupDestination::PROVIDER_SSH => [
                ...
                'secrets.user' => ['nullable', 'string'],
                'secrets.password' => ['nullable', 'string'],
                'secrets.private_key' => ['nullable', 'string'],
                'secrets.private_key_passphrase' => ['nullable', 'string'],
            ],
            BackupDestination::PROVIDER_AZURE_BLOB => [
                'settings.account_name' => ['nullable', 'string', 'max:255'],
                ...
                'secrets.account_key' => ['nullable', 'string'],
            ...
            BackupDestination::PROVIDER_DROPBOX => [
                ...
                'secrets.app_key' => ['nullable', 'string'],
                'secrets.app_secret' => ['nullable', 'string'],
                'secrets.refresh_token' => ['nullable', 'string'],
            ],
            BackupDestination::PROVIDER_GOOGLE_DRIVE => [
                ...
                'secrets.credentials_json' => ['nullable', 'json'],
            ],
